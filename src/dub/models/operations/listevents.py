...
from dub.models.components import (
    clickevents as components_clickevents,
    continentcode as components_continentcode,
    countrycode as components_countrycode,
    leadevents as components_leadevents,
    saleevents as components_saleevents,
)
...
ListEventsResponseBodyTypedDict = Union[
    List[components_clickevents.ClickEventsTypedDict],
    List[components_leadevents.LeadEventsTypedDict],
    List[components_saleevents.SaleEventsTypedDict],
]
r"""A list of events"""


ListEventsResponseBody = Union[
    List[components_clickevents.ClickEvents],
    List[components_leadevents.LeadEvents],
    List[components_saleevents.SaleEvents],
]
r"""A list of events"""
